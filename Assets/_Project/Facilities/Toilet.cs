...
namespace FestivalGrounds.Facilities
{
    ...
    public class Toilet : MonoBehaviour, IFacility
    {
         ...
         private void Awake()
        {
            ...
            if (_userSpotHandler == null) Debug.LogError("FATAL: Toilet is missing UserSpotHandler component!", this);

            _queueHandler = GetComponent<QueueHandler>();
            if (_queueHandler == null) Debug.LogError("FATAL: Toilet is missing QueueHandler component!", this);
            
            _spotGenerator = GetComponent<FacilitySpotGenerator>();
            if (_spotGenerator == null) Debug.LogError("FATAL: Toilet is missing FacilitySpotGenerator component!", this);
        }
